...
SimBox = [200 320 150];%[200 250 150];
...
% %Create cylindrical ring
CSX = AddMetal( CSX, 'ring' );
start=[0 0 0];
stop=[0 0 substrate.thickness];
CSX=AddCylindricalShell(CSX,'ring',5,start,stop,50/2,2,'Transform', {'Translate', '0, 60, 0'});
CSX=AddCylindricalShell(CSX,'ring',5,start,stop,50/2,2,'Transform', {'Translate', '0, -60, 0'});
